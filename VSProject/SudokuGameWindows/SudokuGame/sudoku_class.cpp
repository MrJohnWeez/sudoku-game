...
void game::pause(bool enter){
    string dummy;
    if(enter) cout << setw(67) << "-----Press enter to continue-----" << endl;
    getline(cin,dummy);
    if(dummy[0] == '-'){
        clear();
        exit = true;
...
void game::title(){
    ...
    cout << setw(55) << "-----Press enter to continue-----" << endl;
...
void game::howToPlay(){
    ...
    cout << "________________________________________________________________________________\n"
         ...
         << "  All starting numbers on the board are defult numbers. You cannot change them.\n"
...
void game::credits(){
    cout << "                                       ____  _   _    __    _  _  _  _  ___ \n"
         ...
         << "_____________________________" << "                   ____  _____  ____ \n"
         << "        Game made by:                          " << "( ___)(  _  )(  _ \\\n"
         << " John Wiesner & Aaron Wagner                   " << " )__)  )(_)(  )   /\n"
         << "       2017 Copyright                          " << "(__)  (_____)(_)\\_)\n"
         << "_____________________________"  << "         ____  __      __   _  _  ____  _  _  ___ \n"
         << "                                     (  _ \\(  )    /__\\ ( \\/ )(_  _)( \\( )/ __)\n"
                      "                                      )___/ )(__  /(__)\\ \\  /  _)(_  )  (( (_-.\n"
        ...
        for(unsigned int col = 0; col <= 8; col++){
            ...
            if(row % 2 == 0 && row != 0){
                ...
                if(saveFile.board.boardPlay[row-(validrow+1)][col] == 0){
                    ...
                    cout << to_string(saveFile.board.boardPlay[row-(validrow+1)][col]);
                }else{
                    cout << to_string(saveFile.board.boardPlay[row-(validrow+1)][col]);
                }
            }
...
void game::saveBoard(gameboard &saveFile){
    string name;
    string fileOutName = "SavedBoards/";
